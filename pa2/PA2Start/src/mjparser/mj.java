...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Oct 03 14:56:57 EDT 2018
  */
public class mj extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\011\000\002\002\004\000\002\002\006\000\002\007" +
    "\002\000\002\010\002\000\002\011\002\000\002\006\026" +
    "\000\002\005\004\000\002\005\002\000\002\004\021" });
  ...
  protected static final short[][] _action_table = 
    ...
    "\001\002\000\004\007\035\001\002\000\004\015\036\001" +
    "\002\000\004\010\037\001\002\000\004\060\040\001\002" +
    "\000\004\027\041\001\002\000\004\007\042\001\002\000" +
    "\004\015\043\001\002\000\004\010\044\001\002\000\004" +
    "\060\045\001\002\000\004\027\046\001\002\000\004\064" +
    "\047\001\002\000\004\010\050\001\002\000\004\044\051" +
    "\001\002\000\006\012\ufff9\052\ufff9\001\002\000\004\012" +
    "\ufffb\001\002\000\004\012\ufffd\001\002\000\004\012\055" +
...
class CUP$mj$actions {
  ...
  public final java_cup.runtime.Symbol CUP$mj$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$mj$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // statement ::= MEGGYSETPIXEL LPAREN LPAREN BYTE RPAREN INT_LITERAL COMMA LPAREN BYTE RPAREN INT_LITERAL COMMA COLOR_LITERAL RPAREN SEMI 
            {
              Object RESULT =null;
		int xleft = ((java_cup.runtime.Symbol)CUP$mj$stack.elementAt(CUP$mj$top-9)).left;
		int xright = ((java_cup.runtime.Symbol)CUP$mj$stack.elementAt(CUP$mj$top-9)).right;
		SymbolValue x = (SymbolValue)((java_cup.runtime.Symbol) CUP$mj$stack.elementAt(CUP$mj$top-9)).value;
		int yleft = ((java_cup.runtime.Symbol)CUP$mj$stack.elementAt(CUP$mj$top-4)).left;
		int yright = ((java_cup.runtime.Symbol)CUP$mj$stack.elementAt(CUP$mj$top-4)).right;
		SymbolValue y = (SymbolValue)((java_cup.runtime.Symbol) CUP$mj$stack.elementAt(CUP$mj$top-4)).value;
		...
		SymbolValue color = (SymbolValue)((java_cup.runtime.Symbol) CUP$mj$stack.elementAt(CUP$mj$top-2)).value;
                  ...
                  System.out.println("Generate code for setPixel at (" +
                                      x + ", " + y + ") with color " + color);
                  parser.out.println("    ldi r24, lo8(" + x + ")");
                  parser.out.println("    ldi r22, lo8(" + y + ")");
                  parser.out.println("    ldi r20, lo8(" + color.value + ")");
                  parser.out.println("    call _Z6DrawPxhhh");
                  parser.out.println("    call _Z12DisplaySlatev");
              
              CUP$mj$result = parser.getSymbolFactory().newSymbol("statement",2, ((java_cup.runtime.Symbol)CUP$mj$stack.elementAt(CUP$mj$top-14)), ((java_cup.runtime.Symbol)CUP$mj$stack.peek()), RESULT);
            }
  ...
  java.io.PrintStream sout
                ...
                // Commented out - this always exits...????????
                //System.exit(0);
